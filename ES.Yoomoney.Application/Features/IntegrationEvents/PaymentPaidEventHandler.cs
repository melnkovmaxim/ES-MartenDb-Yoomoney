...
internal sealed class PaymentPaidEventHandler(
    IPaymentService paymentService,
    IEsUnitOfWork unitOfWork,
    IRepository<AccountPaymentEntity> accountPaymentRepository,
    IRepository<UnprocessedPaymentEntity> unprocesedPaymentRepository): INotificationHandler<PaymentPaidIntegrationEvent>
{
    public async Task Handle(PaymentPaidIntegrationEvent @event, CancellationToken ct)
    {
